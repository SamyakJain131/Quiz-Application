...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name)
    {
        ...
        opt1.setBackground(new Color(31,39,49));
        ...
        opt2.setBackground(new Color(31,39,49));
        ...
        opt3.setBackground(new Color(31,39,49));
        opt3.setForeground(Color.WHITE);
        opt3.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt3);
        
        //Radio Button Option4
        opt4 = new JRadioButton();
        opt4.setBounds(170,640,700,30);
        opt4.setBackground(new Color(31,39,49));
        opt4.setForeground(Color.WHITE);
        opt4.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt4);
        
        //Group the Button so one at a time
